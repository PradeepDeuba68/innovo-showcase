  ...
  return (
    <>
      <motion.div
        ...
        transition={{
          type: "spring",
          stiffness: 800, // Increased from 500 for faster movement
          damping: 20, // Reduced from 28 for faster movement
          mass: 0.3, // Reduced from 0.5 for faster movement
        }}
      />
      <motion.div
        ...
        transition={{
          ...
          stiffness: 800, // Increased from 500 for faster movement
          damping: 20, // Reduced from 28 for faster movement
          mass: 0.2, // Reduced from 0.3 for faster movement
        }}
      />
    </>
  );
